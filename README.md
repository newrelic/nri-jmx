...
# New Relic integration for JMX

The New Relic integration for JMX flexibly monitors any application that exposes metrics via JMX.

## Requirements

JMX must be enabled on the monitored host. 
...
For installation and configuration instructions, [see the official documentation](https://docs.newrelic.com/docs/integrations/host-integrations/host-integrations-list/jmx-monitoring-integration).
...
If you want to know more about usage of `./bin/nri-jmx`, pass the `-help` parameter:
...
nri-jmx is licensed under the [Apache 2.0](http://apache.org/licenses/LICENSE-2.0.txt) License.
